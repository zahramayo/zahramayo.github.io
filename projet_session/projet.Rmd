...
<div class="content-box text-justify"> <p><strong>Outils utilisés</strong></p> <p> Pour examiner l’évolution comparative des lancements orbitaux de la Chine, des États-Unis, de la Russie et de l’Europe entre 2000 et 2024, plusieurs outils numériques furent utilisés.<p>
...
<div class="content-box text-justify"> Les trois visualisations produites permettent de mettre en évidence des tendances dans l'évolution des capacités de lancement spatial entre 2000 et 2024 et éclairent les dynamiques de transformation de l'ordre géopolitique spatial. </div> 
...
Cette visualisation nous permet premièrement d'observer une progression marquée de la Chine, qui passe d'une activité marginale au début des années 2000 à un niveau comparable à celui des États-Unis autour de 2020 et qui parvient même à les dépasser de 2018 à 2021. Les États-Unis conservent toutefois une avance importante, notamment à partir de 2022, qui peut s'expliquer principalement grâce à l'intégration de l'acteur privé SpaceX. L'Europe est, elle, marquée par une stagnation puis une chute  après 2020, en raison notamment des retards d'Ariane 6 et de la fin de la collaboration avec la Russie. Enfin, la Russie montre un déclin progressif et continu, accentué après 2014, qui reflète les difficultés structurelles et institutionnelles de son secteur spatial mais également les considérations géopolitiques terrestres, avec les sanctions internationales suite à l'annexion de la Crimée la même année. 
</div>
</div> 
...
<p>
<div class="content-box text-justify">Ce graphique, portant sur la part relative de chaque pays dans le total mondial des lancements annuels, permet d’aller au-delà du simple volume et d’analyser les rapports de force internationaux. On observe ainsi que la Chine accroît progressivement son poids, passant d’environ 5&nbsp;% des lancements mondiaux au début des années 2000 à plus de 20&nbsp;% vingt ans plus tard. Les États-Unis ont toujours une longueur d’avance, mais il est important de rapeller que cette avance est notamment permise grâce à l'intégration du secteur privé, ce dernier s'alliant à l'agence gouvernementale américaine qu'est la NASA. À l’inverse, la part mondiale de l’Europe s’effondre, diminuant à environ 2&nbsp;%, tandis que celle de la Russie connait également un déclin à partir de 2014 malgré une augmentation en 2019. Ces résultats suggèrent que le système spatial mondial, historiquement structuré par la bipolarité entre les États-Unis et la Russie, évolue vers une nouvelle configuration, toujours bipolaire, cette fois-ci entre les États-Unis et la Chine, où cette dernière s’impose comme second pôle spatial tandis que l’Europe perd quant à elle son autonomie stratégique.</div>

<div class="content-box text-justify"> <p><strong>Outils utilisés</strong></p> <p> Les données furent importées dans RStudio afin de pouvoir générer ces graphiques grâce au langage R. Les packages tidyverse, ggplot et plotly furent utilisés afin de pouvoir visualiser les données de manière efficace et interactive grâce à une syntaxe claire. ClaudeAI et ChatGPT ont constitué des outils supplémentaires et complémentaires afin de générer des codes et de corriger toute erreur de programmation concernant les graphiques et la structuration du fichier rmd et html. Finalement, GitHub me permet de stocker les fichiers qui composent ce projet de recherche. </div></div>
...
Les différents outils mobilisés au cours de ce projet ont été sélectionnés en fonction de leur accessibilité, de leur complémentarité et de leur capacité à rendre le processus de recherche transparent et reproductible. Le recours à Gunter’s Space Page s’explique par son accessibilité gratuite et libre, ainsi que par les données claires et pertinentes qui y sont disponibles. Malgré le fait qu’il ne s’agisse pas d’une base institutionnelle, sa réputation en fait un outil fiable pour des analyses quantitatives simples. Cependant, Wikipédia, libre, gratuit et doté d’une grande communauté d’utilisateurs, permit de comparer les données. L’utilisation d’Excel pour préparer et trier les données se justifie par sa simplicité et son efficacité pour structurer des données en tableaux, exportables en CSV. Le choix de R et RStudio pour l’analyse se justifie par la nécessité de produire des visualisations de manière simple, avec des options infinies mais surtout de produire des visualisations reproductibles. RStudio est un outil open source avec une grande communauté d’utilisateurs qui permet une multitude d'usages et une multitude de façons de visualiser ses données. Les packages tidyverse et ggplot ont été privilégiés en raison de leur intuitivité et leur popularité. L’utilisation de plotly permet de rendre la communication scientifique plus intéressante grâce à des visualisations interactives. L’ensemble du processus repose ainsi sur l’utilisation divers d’outils complémentaires, reflétant une approche cohérente fondée sur la transparence, la reproductibilité et l’accessibilité. </div>
...
<p>Pollpeter, K. L. (2020). China's Space Program: Making China Strong, Rich, and Respected. <em>Asia Policy</em>, <em>15</em>(2), 12–18.</p>
